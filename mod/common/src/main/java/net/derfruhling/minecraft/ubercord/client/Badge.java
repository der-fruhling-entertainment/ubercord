...
public enum Badge {
        ...
        return Component.literal(discord)
                ...
                .append(Component.literal("b")
                        .withStyle(Style.EMPTY
                                ...
                                .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.translatable("ubercord.badge.online.hover_badge")))));
    }
    ...
    private static Component newOfflineUserComponent(String ign, String discord, long discordId, Relationship relationship) {
        return Component.literal(discord)
                .withStyle(Style.EMPTY
                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, switch (relationship.gameType()) {
